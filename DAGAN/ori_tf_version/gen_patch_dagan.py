...
parameters = {'data_prefix':'/data_set/Nan/data/segmentation_patches/NEW_Rnegative1_90_Rbackground_80_training_10000_200_val_test_10000_10',
              'training_data_parts': range(150),
              'validation_data_parts': range(150, 170),
              'test_data_parts': range(180, 200)
}

data = dataset.PatchImbalancedDAGANDataset(data_parameters=parameters, batch_size=batch_size, last_training_class_index=1600, reverse_channels=True,
