...
parser.add_argument('--experiment_title', nargs="?", type=str, default="patch_dagan_experiment", help='Experiment name')
...
data = dataset.PatchImbalancedDAGANDataset(batch_size=batch_size, last_training_class_index=1600, reverse_channels=True,
